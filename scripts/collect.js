...
const SOURCE_META = {
  ...
  axios_login:   { label: "Axios Login",         color: "#0062ff", country: "US",     domain: "news" },
  "404media":    { label: "404 Media",           color: "#000000", country: "US",     domain: "news" },
  // 🌎 Round 6: 글로벌 메이저 IT 미디어
  register:      { label: "The Register",        color: "#ee2222", country: "EU",     domain: "news" },
  tnw:           { label: "The Next Web",        color: "#ff6c33", country: "EU",     domain: "news" },
  tomshardware:  { label: "Tom's Hardware",      color: "#1d1d1b", country: "US",     domain: "news" },
  techradar:     { label: "TechRadar",           color: "#00306e", country: "EU",     domain: "news" },
  zdnet:         { label: "ZDNet",               color: "#cc0000", country: "US",     domain: "news" },
  cnet:          { label: "CNET",                color: "#cc0000", country: "US",     domain: "news" },
  gizmodo:       { label: "Gizmodo",             color: "#222222", country: "US",     domain: "news" },
  newstack:      { label: "The New Stack",       color: "#000000", country: "US",     domain: "news",   defaultCat: "ax" },
  infoq:         { label: "InfoQ",               color: "#3164b0", country: "Global", domain: "news",   defaultCat: "ax" },
  infoworld:     { label: "InfoWorld",           color: "#cf202d", country: "US",     domain: "news",   defaultCat: "ax" },
  computerworld: { label: "Computerworld",       color: "#0d3a73", country: "US",     domain: "news" },
  siliconangle:  { label: "SiliconANGLE",        color: "#01b8aa", country: "US",     domain: "news" },
  bloomberg_tech:{ label: "Bloomberg Tech",      color: "#000000", country: "US",     domain: "news" },
  reuters_tech:  { label: "Reuters Tech",        color: "#ff8000", country: "Global", domain: "news" },
  ft_tech:       { label: "Financial Times Tech", color: "#fff1e5", country: "EU",    domain: "news" },
  economist_science: { label: "The Economist Sci/Tech", color: "#e3120b", country: "EU", domain: "news" },
  guardian_tech: { label: "The Guardian Tech",   color: "#052962", country: "EU",     domain: "news" },
  fastcompany:   { label: "Fast Company Tech",   color: "#fa4c0d", country: "US",     domain: "news" },
  businessinsider_tech: { label: "Business Insider Tech", color: "#185abc", country: "US", domain: "news" },
  // 추가 AI 사업자
...
const RSS_FEEDS = [
  // ── 글로벌 일반 IT 뉴스 (Round 6: 한국보다 글로벌 비중 강화) ──
  ...
  // 🌎 Round 6: 글로벌 메이저 IT 미디어 추가 (한국 < 글로벌 비중 정책)
  { source: "register",         url: "https://www.theregister.com/headlines.atom" },
  { source: "tnw",              url: "https://thenextweb.com/feed" },
  { source: "tomshardware",     url: "https://www.tomshardware.com/feeds/all" },
  ...
  { source: "gizmodo",          url: "https://gizmodo.com/rss" },
  { source: "newstack",         url: "https://thenewstack.io/feed/" },
  { source: "infoq",            url: "https://feed.infoq.com/" },
  { source: "infoworld",        url: "https://www.infoworld.com/feed/" },
  { source: "computerworld",    url: "https://www.computerworld.com/feed/" },
  { source: "siliconangle",     url: "https://siliconangle.com/feed/" },
  { source: "bloomberg_tech",   url: "https://feeds.bloomberg.com/technology/news.rss" },
  { source: "reuters_tech",     url: "https://www.reutersagency.com/feed/?best-topics=tech&post_type=best" },
  { source: "ft_tech",          url: "https://www.ft.com/technology?format=rss" },
  { source: "economist_science", url: "https://www.economist.com/science-and-technology/rss.xml" },
  { source: "guardian_tech",    url: "https://www.theguardian.com/uk/technology/rss" },
  { source: "fastcompany",      url: "https://www.fastcompany.com/technology/rss" },
  { source: "businessinsider_tech", url: "https://www.businessinsider.com/tech.rss" },
  { source: "axios_login",      url: "https://api.axios.com/feed/login" },
  // ── 사업자 블로그 — AI / Agent ──────────────────────
