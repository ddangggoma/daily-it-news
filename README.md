...
전체 구조 분석 문서는 [`wiki/index.html`](wiki/index.html)에 있습니다 (정적 HTML, 의존성 0 — 브라우저로 바로 열면 됩니다).
아키텍처 · 파이프라인 6단계 · 수집 소스 125개 카탈로그 · 점수 시스템 · 데이터 계약 · 프런트엔드 런타임 ·
페르소나 · 테스트/CI · 파일 인덱스 · 최신 발행 스냅샷 실측 · 발견된 이슈 12개를 다룹니다.
